    ...
    <div className="bevel mt-5 border border-night-700/70 bg-night-900/60 p-4">
        ...
        >
          <span
            ...
            className={cn(
              ...
              actif ? "border-gold-500 bg-gold-500/25" : "border-night-600 bg-night-800",
            )}
          >
            <span
              className={cn(
                "absolute top-0.5 left-0 block size-4.5 transition-transform motion-reduce:transition-none",
                actif ? "translate-x-5.5 bg-gold-400" : "translate-x-0.5 bg-chalk-500",
              )}
            />
          </span>
        </button>
      ...
      <p
        ...
        className={cn(
          ...
          erreur || etat === "refuse" ? "text-blood-500" : actif ? "text-emerald-400" : "text-chalk-400",
        )}
      >
        {cle ? t(cle) : ""}
      </p>
    ...
    <>
      ...
      <p
        ...
        className={cn(
          ...
          erreur || etat === "refuse" ? "text-blood-500" : "text-chalk-400",
          !cle && "sr-only",
        )}
      >
        {cle ? t(cle) : ""}
